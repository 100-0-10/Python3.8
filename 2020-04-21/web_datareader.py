# -*- coding: utf-8 -*-
"""
Created on Tue Apr 21 12:18:49 2020
...
con = sqlite3.connect('c:/spyder_python/2020-04-21/kospi3.db')
...
index : DataFrame의 index를 데이터베이스에 칼럼으로 추가할지에 대한
        여부를 지정한다
        기본값은 True이다
