...
# 자신의 key를 사용.
gmaps_key = "AIzaSyAn6H_M_yWaeN7HX3E3yjp36J0AKmHM98w"
...
# 현재까지 작업 내용 저장
crime_anal_police.to_csv('02_crime_in_Seoul_include_gu_name.csv', sep = ',', encoding = 'utf-8')
