# -*- coding: utf-8 -*-
"""
Created on Thu Apr 23 14:38:25 2020
...
crime_anal_raw = pd.read_csv('02_crime_in_Seoul_include_gu_name.csv', encoding='utf-8')
...
# 그 값으로 정렬
tmp_max = crime = crime_anal_norm['검거'].max()
...
# 여기까지 작업 저장
crime_anal_norm.to_csv('02_crime_in_Seoul_final.csv', sep = ',', encoding = 'utf-8')
...
#############
# 지도를 이용한 시각화 작업을 위해 지도의 중심 좌표를 이용하여
# 11배 확대
...
webbrowser.open_new("folium_kr.html")     # 저장된 html 기본 브라우저로 열기
