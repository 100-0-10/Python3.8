# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 11:37:44 2020
...
디폴트 포맷 문자열은 'b-'인데 파란색(blue)의 선(line, '-')을 으미
...
# axis()을 이용해서 축의 [xmin, xmax, ymin, ymax] 범위를 지정
plt.axis([0, 6, 0, 20])
plt.show()
...
사실, 모든 시퀀스는 내부적으로 Numpy어레이로 변환된다.
'''
...
세 개의 곡석(y = x, y = x^2, y = x^3)이 동시에 그려진다.
'''
plt.plot(a, a, 'r--',
         a, a**2, 'bo',
         a, a**3, 'g-.')
...
'''
bath() 를 이용하면 수평 막대 그래프를 그릴 수 있다.
'''
